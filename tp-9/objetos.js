...
function sinDocumento(persona) {
    ...
    let personasindocumento={
        ...
        nombre: persona["nombre"],
        edad: persona["edad"],
        docuemento: persona["documento"],
    }
    delete personasindocumento.docummento
...
function nombreCompletoDePersona(persona) {
    // 
    let personaconnombrecompleto={
        nombre: `${persona.nombre}, ${persona.apellido}`,
        edad: persona["edad"],
        apellido: persona["apellido"]
        
    }
    return personaconnombrecompleto;
}
...
function sonLaMismaPersona(persona1, persona2) {
    ...
    if(igualpersona1.documento==igualpersona2.documento){
        return ("si son las mismas personas");
    }else{
...
console.log("resultado sonLaMismaPersona: ", sonLaMismaPersona(
    personaEjemplo,
    { apellido: "Perez", nombre: "Juan", edad: 20, documento: 12345687 }
));
